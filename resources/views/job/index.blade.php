                    ...
                    <form>
                        <div class="row m-1">
                            <div class="col-md-12 input-group">
                                <input type="text" name="q" class="form-control" placeholder="Search By Job Title"
                                    v-model="jobTitle" />
            ...
            <div class="col-sm-12 col-md-5 col-xl-4">
                <div class="card p-0 m-0">
                    <div class="card-body p-3">
                        ...
                        <a href="#" class="job-filter d-md-none d-none" data-toggle="collapse" data-target="#accordion"
                                ...
                                <div class="card-body p-0">
                                    <form method="GET" action="{{ route('job.index') }}">
                                        <select name="job_level" class="form-control" onchange="this.form.submit()">
                                            ...
                                            <option value="Senior level" {{ request('job_level')=='Senior level'
                                                ? 'selected' : '' }}>
                                                Senior level
                                            </option>
                                            <option value="Mid level" {{ request('job_level')=='Mid level' ? 'selected'
                                                : '' }}>
                                                Mid level
                                            </option>
                                            <option value="Top level" {{ request('job_level')=='Top level' ? 'selected'
                                                : '' }}>
                                                Top level
                                            </option>
                                            <option value="Entry level" {{ request('job_level')=='Entry level'
                                                ? 'selected' : '' }}>
                                                Entry level
                                            </option>
                                        </select>
                                ...
                                <div class="card-body p-0">
                                    <form method="GET" action="{{ route('job.index') }}">
                                        <select name="education_level" class="form-control"
                                            ...
                                            <option value="Bachelors" {{ request('education_level')=='Bachelors'
                                                ? 'selected' : '' }}>
                                                Bachelors
                                            </option>
                                            <option value="High School" {{ request('education_level')=='High School'
                                                ? 'selected' : '' }}>
                                                High School
                                            </option>
                                            ...
                                            <option value="Other" {{ request('education_level')=='Other' ? 'selected'
                                                : '' }}>
                                                Other
                                            </option>
                                        </select>
                                ...
                                <div class="card-body p-0">
                                    <form method="GET" action="{{ route('job.index') }}">
                                        <select name="employment_type" class="form-control"
                                            ...
                                            <option value="Full Time" {{ request('employment_type')=='Full Time'
                                                ? 'selected' : '' }}>
                                                Full Time
                                            </option>
                                            <option value="Part Time" {{ request('employment_type')=='Part Time'
                                                ? 'selected' : '' }}>
                                                Part Time
                                            </option>
                                            <option value="Freelance" {{ request('employment_type')=='Freelance'
                                                ? 'selected' : '' }}>
                                                Freelance
                                            </option>
                                            <option value="Internship" {{ request('employment_type')=='Internship'
                                                ? 'selected' : '' }}>
                                                Internship
                                            </option>
                                            <option value="Trainneship" {{ request('employment_type')=='Trainneship'
                                                ? 'selected' : '' }}>
                                                Trainneship
                                            </option>
                                            <option value="Volunteer" {{ request('employment_type')=='Volunteer'
                                                ? 'selected' : '' }}>
                                                Volunteer
                                            </option>
                                        </select>
            ...
            <div class="col-sm-12 col-md-7 col-xl-8">
                ...
                <div>
                    ...
                    <div class="card-body bg-white text-center">
                        <div class="card-text">
                            <img src="{{ secure_asset('images/search-not-found.png') }}" alt="search-not-found-clip" />
                            <h4>
                                No Jobs found
                                <br />
                            ...
                            <div class="row align-items-center text-center text-lg-left">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-3 col-lg-3  mx-auto">
                                    <a href="/job/{{ $post->id }}-{{ $post->job_title }} " target="_blank">
                                        <img class=" img-fluid" src="{{ $post->company->logo }}" width="100px" />
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 pl-0 pl-md-2 pb-2">
                                    ...
                                    <h6 class="mt-2">
                                        <a href="/employer/{{ $post->company->id }}-{{ $post->company->title }}"
