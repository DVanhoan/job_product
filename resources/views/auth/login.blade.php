                ...
                <div class="login-form px-2 pt-4">
                    ...
                    <div class="d-flex justify-content-center mb-3 mt-3">
                        <a href="{{ route('login.google') }}"
                            class="btn btn-outline-secondary rounded-circle p-2 d-flex align-items-center justify-content-center mx-2">
                            <img src="{{ secure_asset('images/google.png') }}" alt="Google Login" width="30px">
                        </a>
                        <a href="{{ route('login.github') }}"
                            class="btn btn-outline-secondary rounded-circle p-2 d-flex align-items-center justify-content-center mx-2">
                            <img src="{{ secure_asset('images/github.png') }}" alt="GitHub Login" width="30px">
                        </a>
                    </div>
...
<style>
    .login-poster {
        background-image: url('{{ secure_asset(' images/login-bg.jpg') }}');
        background-image: linear-gradient(to bottom,
            rgba(0, 0, 0, 0.5),
            rgba(0, 0, 0, 0.35)),
        url('{{ secure_asset(' images/login-bg.jpg') }}');
