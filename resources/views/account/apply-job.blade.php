            ...
            <div class="col-sm-12 col-md-12 mb-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-3">
                                <img src="{{secure_asset('images/user-profile.png')}}" class="img-fluid rounded-circle"
                                    alt="">
                            </div>
                            <div class="col-9">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-3 d-flex align-items-center border p-3">
                                <img src="{{secure_asset($company->logo)}}" class="img-fluid" alt="">
                            </div>
                            <div class="col-9">
                        ...
                        <div class="mb-3 d-flex justify-content-end">
                            <div class="small">
                                ...
                                <form action="{{route('account.applyJob')}}" method="POST" class="d-inline-block">
                                    ...
                                    <button type="submit" class="btn primary-btn">Send Application <i
