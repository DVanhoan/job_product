...
<div class="account-layout border">
    <div class="account-hdr bg-primary text-white border">Dashboard</div>
        ...
        <section class="dashboard-authors my-5">
            <div class="row my-4">
                <div class="col-lg-12 col-md-8 col-sm-12">
                    ...
                    <button class="btn primary-outline-btn disabled">
                        Total Number of authors registered
                        ({{ $recentAuthors->total() }})
                    </button>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    >
                                                        ...
                                                        @method('DELETE')
                                                        <button
                                                            class="btn danger-btn categoryDestroyBtn"
                                                        >
                                                            Delete
                                                        </button>
                                                    </form>
    ...
    <script>
        $(document).ready(function () {
            $('.categoryDestroyBtn').click(function (e) {
                ...
                e.preventDefault()
                if (
                    window.confirm('Are you sure you want delete the Category?')
                ) {
                    selectedForm.submit()
                }
            })
