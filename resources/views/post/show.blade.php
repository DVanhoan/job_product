                ...
                <div class="job-listing border">
                    <div class="company-info">
                        <div class="company-banner">
                            ...
                            <img src="{{ secure_asset('images/companies/nocover.jpg') }}"
                                class="company-banner-img img-fluid" alt="" />
                            @else
                            <img src="{{ secure_asset($company->cover_img) }}" class="company-banner-img img-fluid"
                                alt="" />
                            @endif
                            <div class="company-media">
                                <img src="{{ secure_asset($company->logo) }}" alt="" class="company-logo" />
                                <div>
                                    <a href="{{ route('account.employer', ['id' => $company->id]) }}"
                    ...
                    <div class="job-info">
                        ...
                        <div class="job-bdy p-3 my-3">
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <a href="{{ route('account.applyJobView', ['post_id' => $post]) }}"
                                ...
                                <div class="social-links">
                                    ...
                                    <a href="https://www.gmail.com" target="_blank" class="btn btn-primary">
                ...
                <div class="card d-none d-md-block mb-3">
                    ...
                    <div class="card-body">
                        <div class="btn-group w-100">
                            <a href="{{ route('account.applyJobView', ['post_id' => $post->id]) }}"
                                class="btn primary-outline-btn float-left">
                                Apply Now
                            </a>
                            <a href="{{ route('savedJob.store', ['id' => $post->id]) }}" class="btn primary-btn">
                                <i class="fas fa-star"></i>
                                Save job
                            </a>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="similar-jobs">
                            ...
                            <div class="job-item border-bottom row">
                                <div class="col-4">
                                    <img src="{{ secure_asset($job->company->logo) }}" class="company-logo" alt="" />
                                </div>
                                <div class="job-desc col-8">
                                    <a href="{{ route('post.show', ['job' => $job]) }}"
                                        ...
                                        <p class="font-weight-normal small text-danger">
                                            Deadline:
