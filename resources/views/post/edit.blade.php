...
<div class="account-layout border">
    ...
    <div class="account-bdy p-3">
        <div class="alert alert-primary">
            Your company details will be attached automatically.
        </div>
        <p class="text-primary mb-4">
            Fill in all fields to create a job listing
        </p>
        <div class="row mb-3">
            <div class="col-sm-12 col-md-12">
                <form
                    action="{{ route('post.update', ['post' => $post]) }}"
                    id="postForm"
                    method="POST"
                >
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    type="number"
                                    class="form-control @error('vacancy_count') is-invalid @enderror"
                                    name="vacancy_count"
                                    value="{{ $post->vacancy_count }}"
                                    required
                                />
                                @error('vacancy_count')
                                    <span class="invalid-feedback" role="alert">
...
"
                    ...
                    <button type="button" id="postBtn" class="btn primary-btn">
                        Update Job listing
                    </button>
                </form>
            </div>
