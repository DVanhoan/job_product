<nav class="navbar navbar-expand-md navbar-white bg-white border-bottom sticky-top" id="navbar">
    <div class="container">
        <a href="{{URL('/')}}" class="navbar-brand">
            <img src="{{secure_asset('Logo.svg')}}" alt="">
        </a>
                ...
                <li class="nav-item dropdown dropdown-left">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                        ...
                        <img class="img-profile rounded-circle"
                            src="{{ auth()->user()->avatar ? secure_asset(auth()->user()->avatar) : secure_asset('images/user-profile.png') }}"
                            width="40px" hight="40px">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        @endrole
                        <a class="dropdown-item" href="{{route('account.messages')}}"> <i
                                class="fas fa-user fa-sm "></i> Message </a>
                        ...
                        <a class="dropdown-item" href="{{route('account.changePassword')}}"> <i
                                class="fas fa-key fa-sm "></i> Change Password </a>
