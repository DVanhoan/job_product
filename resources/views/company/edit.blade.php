    ...
    <div class="account-bdy p-3">
        <form action="{{ route('company.update', ['id' => $company->id]) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Company title" class="form-control @error('title') is-invalid @enderror"
                    name="title" value="{{ old('title') ?? $company->title }}" required />
                @error('title')
            ...
            <div class="pb-3">
                <div class="py-3">
                    <p>Company logo</p>
                    <img id="logo_image" src="{{ secure_asset($company->logo) }}" width="80px" alt="" />
                </div>
            ...
            <div class="pb-3">
                <div class="py-3">
                    ...
                    <img id="cover_image" src="{{ secure_asset($company->cover_img) }}" width="200px" class="img-fluid"
                        alt="" />
                </div>
                <div class="custom-file">
            ...
            <div class="form-group">
                ...
                <input type="url" placeholder="https://www.examplecompany.com"
